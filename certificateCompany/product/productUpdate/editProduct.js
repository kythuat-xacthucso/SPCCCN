(function () {
    ...
    function initializeEditor() {
        ...
        quillEditor.root.innerHTML = "<p>Đây là mô tả chi tiết về sản phẩm A. Sản phẩm này có chất lượng cao và được sản xuất theo tiêu chuẩn SPCCCN.</p>";
    ...
    function handleFormSubmit() {
        ...
        form.addEventListener('submit', (e) => {
            ...
            if (isValid) {
                ...
                // Reset form (giả lập, có thể bỏ nếu cần lưu dữ liệu)
                form.reset();
