(function () {
    ...
    ]; // Dữ liệu ảnh giả định
    const MAX_IMAGES = 10;

    // Khởi tạo Quill Editors và điền dữ liệu giả định
    function initializeEditors() {
        ...
        // Điền dữ liệu giả định
        document.getElementById('productName').value = "Sản phẩm A";
        document.getElementById('productPrice').value = "1000000";
        document.getElementById('productStatus').value = "active";
        quillDescription.root.innerHTML = "<p>Đây là mô tả chi tiết về sản phẩm A. Sản phẩm này có chất lượng cao và được sản xuất theo tiêu chuẩn SPCCCN.</p>";
        document.getElementById('categoryChapter').value = "Chương 1";
        document.getElementById('categoryGroup').value = "Nhóm 1";
        document.getElementById('categorySubgroup').value = "Phân nhóm 1";
        document.querySelectorAll('.auto-task-value')[0].value = "24";
        document.querySelectorAll('.auto-task-value')[1].value = "48";
        document.getElementById('productVideo').value = "https://www.youtube.com/watch?v=dQw4w9WgXcQ";
        quillIntro.root.innerHTML = "<p>Giới thiệu về sản phẩm A, sản phẩm tốt nhất trên thị trường.</p>";
        quillLog.root.innerHTML = "<p>Nhật ký cập nhật: Sản phẩm đã được kiểm tra vào ngày 01/05/2025.</p>";
        renderImages();
    ...
    function handleFormSubmit() {
        ...
        form.addEventListener('submit', (e) => {
            ...
            if (isValid) {
                ...
                resultMessage.textContent = 'Sản phẩm đã được sửa thành công!';
                resultMessage.style.color = '#2ecc71';

                // Không reset form để giữ dữ liệu sau khi submit (tùy chỉnh nếu cần)
                // form.reset();
